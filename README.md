...
* **Cost Analysis & Token Consumption**: Detailed pricing and API token usage statistics across different parsers are available in [**Table VI**](./paper-materials/TABLE%20Ⅵ-cost%20analysis%20and%20token%20usage%20statistics.md).
